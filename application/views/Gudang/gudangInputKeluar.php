<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Form Input Barang Keluar </h4>
                </div><!-- /.col -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    <label class="col-form-label-sm" for="diskon">Customer</label>

                                                    <select style="width: 100%;" class='form-control form-control-sm' id='customer' name='customer'>
