                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a onclick="edit('<?= $b['br_id'] ?>')" class="btn btn-secondary btn-sm" href="#" data-toggle="tooltip" title="Bayar"><i class="fas fa-edit"></i></i></a>
