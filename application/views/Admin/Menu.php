               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item <?php if ($namamenu == "Persediaan") {
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url(); ?>gudang/dataBarang" class="nav-link <?php if ($martis == "data_barang") {
                                                                                                                echo "active";
                                                                                                            } ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url(); ?>gudang/barangKeluar" class="nav-link <?php if ($martis == "barang_keluar") {
                                                                                                                echo "active";
                                                                                                            } ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Barang Keluar</p>
